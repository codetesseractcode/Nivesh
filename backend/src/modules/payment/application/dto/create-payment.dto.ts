...
export class CreatePaymentDto {
  ...
  @ApiProperty({ description: 'Payment description', example: 'SIP Investment - March 2026' })
  @IsString()
  description: string;

  @ApiPropertyOptional({ description: 'Customer email', example: 'user@example.com' })
  @IsEmail()
  @IsOptional()
  customerEmail?: string;

  @ApiPropertyOptional({ description: 'Customer phone', example: '+919876543210' })
  @IsString()
  @IsOptional()
